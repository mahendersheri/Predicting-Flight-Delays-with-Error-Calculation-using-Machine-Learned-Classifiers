...
#cache.init_app(app)
app.config['UPLOAD_FOLDER']=r"/Volumes/Macintosh HD - Daten/2021/takeoff/proj2/TK11012/Predicting Flight Delays with Error Calculation using Machine Learned Classifiers/CODE/uploads"
